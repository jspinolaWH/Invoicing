...
import com.example.invoicing.repository.BillingRestrictionRepository;
...
import com.example.invoicing.entity.billingrestriction.dto.BillingRestrictionRequest;
import com.example.invoicing.entity.billingrestriction.dto.BillingRestrictionResponse;
...
public class BillingRestrictionService {
    ...
    public List<String> getImmediateServiceTypes() {
        return repository.findByBillingTypeAndActiveTrue(BillingType.IMMEDIATE).stream()
            .map(BillingRestriction::getServiceType)
