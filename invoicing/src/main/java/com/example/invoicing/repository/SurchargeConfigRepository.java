...
public interface SurchargeConfigRepository extends JpaRepository<SurchargeConfig, Long> {
    ...
    Optional<SurchargeConfig> findByDeliveryMethodAndCustomerTypeAndActiveTrue(DeliveryMethod deliveryMethod, CustomerType customerType);

    Optional<SurchargeConfig> findByDeliveryMethodAndCustomerTypeIsNullAndActiveTrue(DeliveryMethod deliveryMethod);
